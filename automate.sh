...
mkdir -p generated_files/hotspot_outputs/tensor_size_$1_$4_layer_$2
echo "Creation done"
...
cp generated_files/hotspot_outputs/steady/fermi.steady generated_files/hotspot_outputs/tensor_size_$1_$4_layer_$2/
cp generated_files/hotspot_outputs/steady/fermi.grid.steady generated_files/hotspot_outputs/tensor_size_$1_$4_layer_$2/
echo "Copying done"

# Running HotSpot scripts for heat map image generation
echo "Running hotspot scripts for generation of the heat map image..."
python3 HotSpot/scripts/split_grid_steady.py generated_files/hotspot_outputs/steady/fermi.grid.steady 4 8 8
